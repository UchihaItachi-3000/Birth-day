...
const imgHeight = 500px; // Height of images (px)
...
// Create the "CLICK ME FIRST" button
// const clickMeFirstButton = document.createElement('button');
// clickMeFirstButton.textContent = 'CLICK ME FIRST ';
// clickMeFirstButton.className = 'glow-on-hover btn';
// clickMeFirstButton.style.cssText = `
//   position: absolute;
//   top: 50%;
//   left: 50%;
//   transform: translate(-50%, -50%);
//   z-index: 10; // Ensure it overlaps the wish button
//   padding: 10px 20px;
//   font-size: 20px;
...
//   cursor: pointer;
// `;
const clickMeFirstButton = document.getElementById('first-click');
const dragcontainer = document.getElementById('drag-container');
// Append the button to the body
// document.body.appendChild(clickMeFirstButton);

// Add click event listener to the button
clickMeFirstButton.addEventListener('click', () => {
  document.body.removeChild(clickMeFirstButton);
  console.log('okkk');
  initializeMusic();
...
`;
  ...
  function showFinalBirthdayMessage() {
    ...
    nameElement.innerHTML = '<span class="name-highlight">V a i s h n a v i</span>';
